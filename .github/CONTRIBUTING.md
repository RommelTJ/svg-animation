# Contributing to SVG Animation
♥ [SVG Animation](https://github.com/RommelTJ/svg-animation) and want to get involved?
...
The [issue tracker](https://github.com/RommelTJ/svg-animation/issues) is
